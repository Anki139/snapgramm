      ...
      <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
        ...
        <div>
            <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
                <img src={assets.group_users} className=" h-10 md:h-10" alt="" />
                <div> 
                    <div className='flex'>
            ...
            <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>Connect with the Global Community</p>
        </div>
