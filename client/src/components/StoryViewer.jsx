...
if(!viewStory) return null;
  ...
  return (
    ...
    >
      ...
      {/* user info top left  */}
      <div className="absolute top-4 flex items-center space-x-3 p-2 px-4 sm:p-4 sm:px-8 backdrop-blur-2xl rounded bg-black/50 ">
        <img
      ...
      <button onClick={handleClose} className='absolute top-4 right-4 text-white text-3xl focus:outline-none font-bold'>
